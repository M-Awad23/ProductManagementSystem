...
namespace ProductManagementSystem.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<(bool Success, string? ErrorMessage)> UploadProfilePhotoAsync(
            string userId,
            IFormFile? photo)
        {
            ...
            try
            {
                ...
                _logger.LogInformation(
                    "Profile photo uploaded/replaced for UserId {UserId}.",
                    userId);
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(
                    ex,
                    "Failed to upload profile photo for UserId {UserId}.",
                    userId);
        ...
        public async Task<bool> DeleteProfilePhotoAsync(string userId)
        {
            ...
            _logger.LogInformation(
                "Profile photo deleted for UserId {UserId}.",
                userId);
